...
**Use `N` (1, 2, 3, …)** — see [`STEPS.md`](STEPS.md). Next: **`N = 82`**.
...
| [12](epics/12-forge-observe.md) | Forge Observe | In progress | 4/7 steps; correlated log query API (`GET /v1/logs`) over Loki |
