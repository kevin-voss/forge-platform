...
Permission-aware AI agent runtime.

## Why this epic exists

See `specs.md` Step 15. This epic will be decomposed into **multiple atomic steps** before implementation.
...
Defined during planning (`PLAN_STEPS.md`). Spec seed: see `specs.md` Step 15 demo section.

## Planned steps

> Not planned yet. Run the planning prompt with `EPIC_ID=15-forge-agents`.
