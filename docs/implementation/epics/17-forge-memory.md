...
|---|---|---|---|
| [17.01](../steps/17-forge-memory/17.01-skeleton-persistence.md) | Skeleton + persistence | Not started | Rust, health, port 4303, persistence dir |
...
**[17.01](../steps/17-forge-memory/17.01-skeleton-persistence.md) — Skeleton + persistence** (Rust service scaffold, health, durable persistence dir, Compose on port `4303`).
