...
|---|---:|---|---|---|
| [21.01](../steps/21-forge-discovery/21.01-skeleton-and-registry-model.md) | 140 | Service skeleton + Service/Endpoint resource model | Not started | New Go service, port 4109; kind registration; persistence choice |
...
**[21.01](../steps/21-forge-discovery/21.01-skeleton-and-registry-model.md) — Service skeleton + Service/Endpoint resource model** (service skeleton, kind registration, persistence choice; unblocks the rest of the epic).
