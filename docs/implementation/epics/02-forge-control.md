...
|---|---|---|---|
| [02.01](../steps/02-forge-control/02.01-service-skeleton.md) | Service skeleton, health, Compose | Not started | Ktor module, Makefile, Dockerfile, port 4001 |
...
**[02.01](../steps/02-forge-control/02.01-service-skeleton.md) — Service skeleton, health, Compose** (stand up the Ktor module, health endpoints, Dockerfile, and Compose wiring on port `4001` before any domain logic).
