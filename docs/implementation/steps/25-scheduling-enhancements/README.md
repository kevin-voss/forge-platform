...
| Step | N | File | Status |
|---|---:|---|---|
| 25.01 | 168 | [25.01-resource-requests-limits-and-capacity.md](25.01-resource-requests-limits-and-capacity.md) | Complete |
| 25.02 | 169 | [25.02-labels-selectors-taints-tolerations.md](25.02-labels-selectors-taints-tolerations.md) | Complete |
