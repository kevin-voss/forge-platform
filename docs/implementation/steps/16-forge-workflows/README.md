...
Epic: [`../../epics/16-forge-workflows.md`](../../epics/16-forge-workflows.md) · Status: **Planning**
...
|---|---|---|---|
| [16.01](16.01-skeleton-otp-health.md) | Skeleton OTP + health | Not started | 00, 01 |
...
| [16.06](16.06-compensation-rollback.md) | Compensation/rollback via Control | Not started | 16.05, 02/07 |
| [16.07](16.07-demo-and-gate.md) | Demo `16-agent-workflow` + gate | Not started | 16.06 |

Next to implement: **16.01**.
