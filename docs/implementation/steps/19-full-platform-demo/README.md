...
Epic: [`../../epics/19-full-platform-demo.md`](../../epics/19-full-platform-demo.md) · Status: **Planning**
...
|---|---|---|---|
| [19.01](19.01-polyglot-product-scaffold.md) | Polyglot sample product | Not started | 01 |
